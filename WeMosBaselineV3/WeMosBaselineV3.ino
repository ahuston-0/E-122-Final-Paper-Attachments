...
char* MQtopic1 = "E122/D1B6/Temperature";
char* MQtopic2 = "E122/D1B6/Humidity";
char* MQtopic3 = "E122/D1B6/Light";
...
//any code in this function runs once at startup
void setup() {
  ...
  if(!DEBUG){Serial.print("Mac Address:"); Serial.println(board_info.mac());}
  ...
  client.setServer(mqtt_server, 1883);  //MQTT server IP address and port
  client.setCallback(callback);  //specify function for MQTT subscribe callbacks
}
...
{   //start loop
  ...
  if(SLEEP_MODE)sleep.sleep();
  // put any additional code you wish to run repeatedly here
